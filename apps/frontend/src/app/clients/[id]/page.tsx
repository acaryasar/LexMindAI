...
import { generateMockClients, generateMockCases, generateMockDocuments } from '@/lib/mock-data';
...
export default function ClientDetailPage() {
  ...
  const fetchClientData = async () => {
    try {
      ...
      const foundClient = mockClients.find((c: any) => c.id === params.id);
      setClient(foundClient || mockClients[0]);
      setCases(mockCases);
      ...
      <div className="flex">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="px-8 py-6">
            ...
            {activeTab !== 'overview' && activeTab !== 'cases' && activeTab !== 'documents' && (
              <Card>
