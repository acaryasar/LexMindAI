  ...
  return (
    <div className="w-full h-full bg-white/90 dark:bg-gray-900/90 backdrop-blur-xl border-l border-gray-200/50 dark:border-gray-700/50 flex flex-col shadow-2xl">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <div className="px-4 pt-4 pb-2 bg-transparent border-b border-gray-200/50 dark:border-gray-700/50">
          <div className="grid grid-cols-3 gap-2">
            ...
            <button
              onClick={() => setActiveTab(activeTab === 'writing' ? null : 'writing')}
              className={cn(
                'flex items-center justify-center gap-2 px-3 py-2 rounded-lg text-sm font-medium transition-all',
                activeTab === 'writing' 
                  ? 'bg-purple-100 dark:bg-purple-900/20 text-purple-700 dark:text-purple-300' 
            ...
            <button
              onClick={() => setActiveTab(activeTab === 'precedent' ? null : 'precedent')}
              className={cn(
                'flex items-center justify-center gap-2 px-3 py-2 rounded-lg text-sm font-medium transition-all',
                activeTab === 'precedent' 
                  ? 'bg-purple-100 dark:bg-purple-900/20 text-purple-700 dark:text-purple-300' 
            ...
            <button
              onClick={() => setActiveTab(activeTab === 'control' ? null : 'control')}
              className={cn(
                'flex items-center justify-center gap-2 px-3 py-2 rounded-lg text-sm font-medium transition-all',
                activeTab === 'control' 
                  ? 'bg-purple-100 dark:bg-purple-900/20 text-purple-700 dark:text-purple-300' 
            ...
            <button
              onClick={() => setActiveTab(activeTab === 'final' ? null : 'final')}
              className={cn(
                'flex items-center justify-center gap-2 px-3 py-2 rounded-lg text-sm font-medium transition-all',
                activeTab === 'final' 
                  ? 'bg-purple-100 dark:bg-purple-900/20 text-purple-700 dark:text-purple-300' 
        ...
        {/* Tab Content - Expands when active */}
        {activeTab && (
          <div className="flex-1 min-h-[400px] overflow-y-auto p-4 space-y-4 animate-in fade-in slide-in-from-top-2 duration-300">
            {/* Quick Actions Tab */}
            {activeTab === 'quick' && (
        ...
        {/* Prompt Library - Only show when no tab is active */}
        {!activeTab && (
          <div className="border-t border-gray-200/50 dark:border-gray-700/50 p-4 animate-in fade-in duration-300">
